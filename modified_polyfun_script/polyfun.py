...
class PolyFun:
    ...
    def save_snpvar_to_disk(self, args, use_ridge, constrain_range):
        ...
        if constrain_range:
            ...
            print("this is where that have assertion error about df_snpvar['SNPVAR'].sum() AND h2_total not close")
            print("df_snpvar['SNPVAR'].sum() = ", df_snpvar['SNPVAR'].sum() )
            print("h2_total = ", h2_total)

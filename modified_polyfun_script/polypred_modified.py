...
def compute_prs_for_file(args,
    ...
    test = '/gfps/commons/home/tlin/polyfun_omer/modified/test'
    #Run plink
...
#        outfile_prs_temp,
    ...
    print("start run plink")
    os.system(plink_cmd)
    print("finish plink")

#    outputfile = test+'.profile'
#    with open(outputfile) as f:
#         print("try to read the first line of outputfile")
#         print(f.readlines())
#    close(outputfile)

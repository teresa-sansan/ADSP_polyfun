...
print("check if theres NAs")
print(phenotype_chirag_noNA.isna().sum())

def combine_phenotype_polypred(polypred, phenotype = phenotype_chirag_noNA, savename):
    input_shape = phenotype.shape
    polypred=phenotype.merge(polypred, right_on = "IID", left_on = "SampleID",axis=1)

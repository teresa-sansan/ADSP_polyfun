...
#SBATCH --output=/gpfs/commons/home/tlin/output/bellenguez/bellenguez_all_2/finemap_snpvar_constrained/max_snp_1/%x_%j.log
	...
	python finemapper.py \
		...
		--n 487511 \
	  	...
	  	--method susie \
     	  	--max-num-causal 1 \
	  	--allow-missing \
		--out "/gpfs/commons/home/tlin/output/bellenguez/bellenguez_all_2/finemap_snpvar_constrained/max_snp_1/finemap_bellenguez_all_2.${chr}.$start.$end.gz"

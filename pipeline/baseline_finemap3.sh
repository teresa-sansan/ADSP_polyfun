#!/bin/bash
#SBATCH --job-name=baseline_finemap_3
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=tlin@nygenome.org
#SBATCH --mem=50G
#SBATCH --time=08:00:00
#SBATCH --output=output/bl/output/finemap/max_causal_3/%x_%j.log
	...
	python finemapper.py \
		...
		--n 63926 \
	  	...
	  	--method susie \
     	  	--max-num-causal 3 \
	  	--allow-missing \
		--out ~/polyfun/output/bl/output/finemap/max_causal_3/finemap_bl.${chr}.$start.$end.gz \

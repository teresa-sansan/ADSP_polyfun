#!/bin/bash
#SBATCH --job-name=bl_deepsea_brain_atac.1_2.3.4
#SBATCH --mail-type=FAIL
#SBATCH --mail-user=tlin@nygenome.org
#SBATCH --mem=450G
#SBATCH --time=05:00:00
#SBATCH --output=output/bl_deepsea_brain_atac/%x_%j.log

...
#SBATCH --output=/gpfs/commons/home/tlin/output/bellenguez/bellenguez_updateRSID/%x%j.log
...
summary_stats='/gpfs/commons/home/tlin/data/bellenguez_2021_final.tsv.gz'

...
##/gpfs/commons/home/tlin/output/cT/new_plink_genomewide/bellenguez/new_sep22/
...
##jansen
if true; then
sumstat_file='Jansen_et_al_2019_hg37_ldsc'
sumstat_qc_file='Jansen_qc.tsv'
...
sumstat_qc_file='wightman_fixed_beta_qc'
#sumstat_qc_file='wightman_chr_sep/wightman_fixed_beta_qc_chr'
sumstat_file='wightman_chr_sep/wightman_fixed_beta_chr'
beta=10
#$processed/wightman_chr_sep/wightman_fixed_beta_chr${chr}.tsv 1 4 $beta header \
#-q-score-range range_list.txt $processed/wightman_chr_sep/wightman_fixed_beta_chr${chr}.pvalue  \
fi
...
sumstat_qc_file='Bellenguez_et_al_2021_hg37_new_sep20_qc'
beta=11
#$processed/${sumstat_file}.pvalue 
#${sumstat_file}.tsv
fi
...
##qc on both
    if false; then
        ...
        ~/plink \
            ...
            --score $processed/${sumstat_qc_file}.tsv 1 4 $beta header \
    ...
    if true; then
        ...
        ~/plink \
            ...
            --score $processed/${sumstat_file}.tsv 1 4 $beta header \

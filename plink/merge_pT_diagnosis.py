...
for anno in ["susie","baseline","omics","omics_dl"]:
    ...
    prs = [prs_0,prs_1,prs_2,prs_3,prs_4,prs_5,prs_6,prs_7,prs_8]  
    prs_merge = reduce(lambda left, right:pd.merge(left,right,on=["IID"]),prs)
    prs_merge = prs_merge.set_axis( ["IID","PRS_0","PRS_1","PRS_2","PRS_3","PRS_4","PRS_5","PRS_6","PRS_7","PRS_8"], axis='columns')

#!/bin/bash
#SBATCH --job-name=noclump_maxsnp10
...
#awk 'NR!=1{print $3}' $clump_path/new_beta/kunkle_${chr}.clumped > $clump_path/new_beta/kunkle_${chr}.valid.snp ## only include this line if you did clumping beforehand
...
--out $clump_path/new_beta/max_snp_10_no_clump_pT_chr${chr}
fi

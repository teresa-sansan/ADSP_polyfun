...
#SBATCH --mem=100G
#SBATCH --time=5:00:00
#SBATCH --output=/gpfs/commons/home/tlin/output/wightman/new_anno_0203/update_all+enformer/finemap/%x_%j.log
...
path='/gpfs/commons/home/tlin/output/bellenguez/old/bellenguez_fixed_0224_annotations/'
fi
...
#prefix='all_anno'
path='/gpfs/commons/home/tlin/output/wightman/new_anno_0203/update_all+enformer'

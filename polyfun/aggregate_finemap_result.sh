...
#SBATCH --mem=100G
#SBATCH --time=3:00:00
#SBATCH --output=/gpfs/commons/home/tlin/output/bellenguez/bellenguez_updateRSID/finemap_susie/%x_%j.log
...
prefix='bellenguez_susie'
#path='/gpfs/commons/home/tlin/output/bellenguez/bellenguez_fixed_0224/finemap'
path='/gpfs/commons/home/tlin/output/bellenguez/bellenguez_updateRSID/finemap_susie'

...
do
	...
	do
		python create_finemapper_jobs.py \
			--sumstats /gpfs/commons/home/tlin/output/bellenguez/bellenguez_updateRSID/bellenguez_all.${chr}.snpvar_constrained.gz \
   	 		--n 487511 \
			--method susie \
    			--max-num-causal $max_snp \
			--out-prefix /gpfs/commons/home/tlin/output/bellenguez/bellenguez_updateRSID/finemap_check_pipeline/bellenguez \

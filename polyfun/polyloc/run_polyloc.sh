#!/bin/bash
#SBATCH --job-name=polyloc_pip0_
#SBATCH --mail-type=FAIL,END
#SBATCH --mail-user=tlin@nygenome.org
#SBATCH --mem=50G 
#SBATCH --time=30:00:00
#SBATCH --output=/gpfs/commons/home/tlin/output/wightman/new_anno_0203/update_all+enformer/finemap/polyloc/pip_not0/%x%j.log
...
python polyloc_reclone/polyloc.py \
    --compute-partitions \
    --output-prefix $polyfun_path/polyloc/pip_not0/polyloc \
    --compute-ldscores \

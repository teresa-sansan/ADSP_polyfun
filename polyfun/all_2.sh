...
#SBATCH --output=/gpfs/commons/home/tlin/output/bellenguez/new_sep22/all_anno/%x_%j.log
...
summary_stats='/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/summary_stats/alzheimers/fixed_alzheimers/Bellenguez_et_al_2021_hg37_new_sep20.tsv.gz'

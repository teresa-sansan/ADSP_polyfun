...
#SBATCH --output=/gpfs/commons/home/tlin/output/bellenguez/bellenguez_updateRSID/finemap/max_snp_1/%x_%j.log
	...
	python finemapper.py \
		...
		--n 487511 \
	  	...
	  	--method susie \
     	  	--max-num-causal 1 \
	  	--allow-missing \
		--out "/gpfs/commons/home/tlin/output/bellenguez/bellenguez_updateRSID/finemap/max_snp_1/finemap_bellenguez.${chr}.$start.$end.gz"

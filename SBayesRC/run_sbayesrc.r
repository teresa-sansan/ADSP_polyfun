...
ma_file="/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/summary_stats/alzheimers/fixed_alzheimers/processed/sbayesrc/bellenguez_hg38_chr22_from_parquet_reversed.cojo"     # GWAS summary in COJO format (the only input)
...
annot="/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/annotations/4SBayesRC/hg38/bl_chr22.tsv" 
...
## tidy sumstat
tidy(mafile=ma_file, LDdir=ld_folder, output= paste(dirname(ma_file), 'bellenguez_hg38_chr22_reversed_tidy.ma', sep = '/'), log2file=TRUE)
...
impute(mafile=file.path(dirname(ma_file), 'bellenguez_hg38_chr22_reversed_tidy.ma'), LDdir=ld_folder,output='/gpfs/commons/home/tlin/output/sbayesRC/bellenguez/bl/chr22_imp.ma', log2file=TRUE)

# # SBayesRC: main function for SBayesRC
sbayesrc(mafile=file.path(dirname(ma_file), 'bellenguez_hg38_chr22_reversed_tidy.ma'), LDdir=ld_folder, outPrefix="/gpfs/commons/home/tlin/output/sbayesRC/bellenguez/bl/chr22_sbrc", annot=annot, log2file=TRUE)

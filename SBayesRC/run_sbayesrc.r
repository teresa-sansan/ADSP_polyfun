...
# write.table(snpinfo, "/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/LD/LD_sbayesrc/ADSP_hg38/rerun_LD_sbayesrc/snp.info", row.names = FALSE, sep = "\t", quote = FALSE)
...
#impute(mafile=paste(dirname(ma_file), '/bellenguez_hg38_chr',chrom,'_reversed_a1a2_tidy.ma', sep = ''), LDdir=ld_folder, 

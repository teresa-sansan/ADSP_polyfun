...
bellenguez["POS"] = bellenguez['CHR'].astype(str) +'_'+ bellenguez["BP"].astype(str) + '_' + bellenguez["A1"]+ '_' +bellenguez["A2"]
bellenguez_19["POS"] = bellenguez_19['CHR'].astype(str) +'_'+ bellenguez_19["BP"].astype(str) + '_' + bellenguez_19["Allele1"]+'_'+bellenguez_19["Allele2"]

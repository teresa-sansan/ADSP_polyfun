...
for anno in anno_list:
    ...
    if True:
        ...
        prs1 = pd.read_csv(path+anno+'/finemap/polypred/17k_ibd_max_snp_1' + name , sep = '\t')
        #prs3 = pd.read_csv(path+anno+'/finemap/polypred/max_snp_3' + name, sep = '\t')
        #prs5=pd.read_csv(path, sep = '\t')
        prs5 = pd.read_csv(path+anno+'/finemap/polypred/17k_ibd_max_snp_5' + name, sep = '\t')
...
#    pheno = pd.read_csv('/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/ADSP_vcf/phenotype_file/release_36K/pheno_ADSP_IBD.tsv', sep = '\t')
    ...
    save_name_full='/gpfs/commons/home/tlin/output/prs/polypred/wightman/susie.17k.tsv'

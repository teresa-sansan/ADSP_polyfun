...
prs1 = pd.read_csv(path+'max_snp_1.prs', sep = '\t' )
prs3 = pd.read_csv(path+'max_snp_3.prs', sep = '\t') 
prs5 = pd.read_csv(path+'max_snp_5.prs', sep = '\t')
prs7 = pd.read_csv(path+'max_snp_7.prs', sep = '\t')
prs10 = pd.read_csv(path+'max_snp_10.prs', sep = '\t')

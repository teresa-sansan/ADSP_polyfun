...
d8_cleaned <- d8[complete.cases(d8[, c('AGE_harmonized','DX_harmonized')]), ]
#write.table(d8_cleaned, file="/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/ADSP_vcf/phenotype_file/release_36K/ADSP_LISAN_output.csv", row.names = FALSE, sep="\t", quote=FALSE)
```
```{r}
fin = d8_cleaned[d8_cleaned$AGE_harmonized >= 65,]
```

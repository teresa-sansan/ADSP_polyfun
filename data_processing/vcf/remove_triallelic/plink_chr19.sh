#!/bin/sh
#SBATCH --job-name=plink_vcf_chr19
...
/gpfs/commons/home/tlin/plink --bfile ADSP_annotated_chr19 --snps-only --exclude ADSP_annotated_whole_genome-merge.missnp --make-bed --out remove_triallelic/chr19.uni

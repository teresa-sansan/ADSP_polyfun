...
/gpfs/commons/home/tlin/plink --bfile ADSP_annotated_chr6 --snps-only --exclude ADSP_annotated_whole_genome-merge.missnp --make-bed --out remove_triallelic/chr6.uni

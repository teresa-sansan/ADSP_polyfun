#!/bin/sh
#SBATCH --job-name=plink_vcf_chr14
...
/gpfs/commons/home/tlin/plink --bfile ADSP_annotated_chr14 --snps-only --exclude ADSP_annotated_whole_genome-merge.missnp --make-bed --out remove_triallelic/chr14.uni

#!/bin/sh
#SBATCH --job-name=plink_vcf_chr8
...
/gpfs/commons/home/tlin/plink --bfile ADSP_annotated_chr8 --snps-only --exclude ADSP_annotated_whole_genome-merge.missnp --make-bed --out remove_triallelic/chr8.uni

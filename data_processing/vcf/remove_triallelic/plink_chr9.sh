#!/bin/sh
#SBATCH --job-name=plink_vcf_chr9
...
/gpfs/commons/home/tlin/plink --bfile ADSP_annotated_chr9 --snps-only --exclude ADSP_annotated_whole_genome-merge.missnp --make-bed --out remove_triallelic/chr9.uni

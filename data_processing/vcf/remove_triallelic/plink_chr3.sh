#!/bin/sh
#SBATCH --job-name=plink_vcf_chr3
...
/gpfs/commons/home/tlin/plink --bfile ADSP_annotated_chr3 --snps-only --exclude ADSP_annotated_whole_genome-merge.missnp --make-bed --out remove_triallelic/chr3.uni

#!/bin/sh
#SBATCH --job-name=plink_vcf_chr21
...
/gpfs/commons/home/tlin/plink --bfile ADSP_annotated_chr21 --snps-only --exclude ADSP_annotated_whole_genome-merge.missnp --make-bed --out remove_triallelic/chr21.uni

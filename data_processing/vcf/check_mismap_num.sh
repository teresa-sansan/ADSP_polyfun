...
## check position
output='/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/ADSP_vcf/17K_final/annotated_filtered_hg37/only_position/map_result_mismap.txt'
...
echo aka. there are $wrong "("$percent3 ")" SNPs incorrectly mapped in the chr $i. | tee -a $output
echo |tee -a $output

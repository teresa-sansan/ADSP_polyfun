...
grep -F -v -x -f Kunkle_APOE.tsv Kunkle_et_al_2019_hg37_ldsc.tsv > Kunkle_remove_APOE.tsv
grep -F -v -x -f Kunkle_APOE_qc.tsv Kunkle_et_al_2019_hg37_ldsc_qc.tsv > Kunkle_remove_APOE_qc.tsv

...
#SBATCH --mem=20G
#SBATCH --time=3:00:00
#SBATCH --output=/gpfs/commons/home/tlin/output/prs/PRSCS/36k_ibd_adsp_fixed/bellenguez/%x%j.log
...
--q-score-range /gpfs/commons/home/tlin/script/plink/range_list2.txt $bellenguez_snp  \
--out $path/chr${chr}.qc

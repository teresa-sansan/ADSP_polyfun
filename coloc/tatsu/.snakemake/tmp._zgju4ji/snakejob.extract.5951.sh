#!/bin/sh
# properties = {"type": "single", "rule": "extract", "local": false, "input": ["/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/eQTL/microglia_GENCODE_expression_full_assoc.tsv.gz"], "output": ["/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/eQTL/microglia/gene/ENSG00000165948.11_sumstats_hg38.gz"], "wildcards": {"gene": "ENSG00000165948.11"}, "params": {}, "log": [], "threads": 1, "resources": {"tmpdir": "/scratch"}, "jobid": 5951, "cluster": {}}
 cd /gpfs/commons/home/tlin/script/coloc_raj_pipeline/tatsu && \
/gpfs/commons/home/tlin/.conda/envs/polyfun/bin/python3.6 \
-m snakemake /gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/eQTL/microglia/gene/ENSG00000165948.11_sumstats_hg38.gz --snakefile /gpfs/commons/home/tlin/script/coloc_raj_pipeline/tatsu/Snakefile \
...
--mode 2  --default-resources "tmpdir=system_tmpdir"  && touch /gpfs/commons/home/tlin/script/coloc_raj_pipeline/tatsu/.snakemake/tmp._zgju4ji/5951.jobfinished || (touch /gpfs/commons/home/tlin/script/coloc_raj_pipeline/tatsu/.snakemake/tmp._zgju4ji/5951.jobfailed; exit 1)

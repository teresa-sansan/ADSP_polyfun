...
install.packages(c('echolocatoR','optparse','coloc'))
...
gwas_folder <- "/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/summary_stats/alzheimers/ADSP_reference_panel/fine_mapping/annotations_dl/"
...
gene_meta <- readr::read_tsv("/gpfs/commons/groups/knowles_lab/data/ADSP_reguloML/eQTL/gencode.v30.tx2gene.tsv") %>%
